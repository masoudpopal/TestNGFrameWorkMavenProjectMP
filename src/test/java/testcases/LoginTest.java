...
public class LoginTest extends CommonMethods {
    ...
    public void adminLogin(){
        //all the locators for the username and password are inside the LoginPage class so inorder to get those objects we need to create the object of that class.
        LoginPage login=new LoginPage();
        sendText(login.usernameBox, ConfigReader.getPropertyValue("username"));
                 //This is WebElement  //in here we pass the value by configReader
